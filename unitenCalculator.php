...
<head>
  ...
  <title>CGPA Calculator Uniten</title>
...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="unitenLogo.png" alt="" width="150px;">
      <h1>CGPA Calculator (Universiti Tenaga Nasional)</h1>
    </div>
          ...
          <div class="two fields subject1" id="Subject">
            <div class="field" id="grade1">
              ...
              <select class="ui dropdown1" name="grade1" onchange="pFunction1()">
                ...
                <option value="0.00" <?php if (isset($grade) && $grade=="0.00") echo "checked";?>>E</option>
              </select>
            </div>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Universiti Tenaga Nasional (Uniten)</h3>
        <table class="ui inverted fixed single line celled table ">
          ...
          <tr>
            ...
            <td data-label="Marks">43-44</td>
            <td data-label="Grade Points">1.33</td>
            </tr>
            <tr>
            <td data-label="Letter">D</td>
            <td data-label="Marks">40-42</td>
