...
<head>
  ...
  <title>CGPA Calculator UIAM</title>
...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="uiaLogo.png" alt="" width="125px;">
      <h1>CGPA Calculator (Universiti Islam Antarabangsa Malaysia)</h1>
    </div>
          ...
          <div class="two fields subject1" id="Subject">
            <div class="field" id="grade1">
              ...
              <select class="ui dropdown1" name="grade1" onchange="pFunction1()">
                ...
                <option value="1.67" <?php if (isset($grade) && $grade=="1.67") echo "checked";?>>D+</option>
                <option value="1.33" <?php if (isset($grade) && $grade=="1.33") echo "checked";?>>D</option>
                <option value="1.00" <?php if (isset($grade) && $grade=="1.00") echo "checked";?>>E</option>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Universiti Islam Antarabangsa Malaysia (UIAM)</h3>
