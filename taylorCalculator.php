...
<head>
  ...
  <title>CGPA Calculator Taylor</title>
...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="taylorLogo.png" alt="" width="150px;">
      <h1>CGPA Calculator (Taylor's University)</h1>
    </div>
          ...
          <div class="two fields subject1" id="Subject">
            <div class="field" id="grade1">
              ...
              <select class="ui dropdown1" name="grade1" onchange="pFunction1()">
                ...
                <option value="0.67" <?php if (isset($grade) && $grade=="0.67") echo "checked";?>>D-</option>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Taylor's University</h3>
