...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="umLogo.png" alt="" width="125px;">
      <h1>Grade Target (Universiti Malaya)</h1>
    </div>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Universiti Malaya / University of Malaya (UM)</h3>
