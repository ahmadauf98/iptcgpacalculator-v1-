 ...
 <!-- Navigation Bar Section-->
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      ...
      <h1>Grade Target (Universiti Kebangsaan Malaysia)</h1>
    </div>
          ...
          <div class="field">
            ...
            <div class="field">
              ...
              <select class="ui dropdown1" name="tg1">
                ...
                <option value="85" <?php if (isset($tg1) && $tg1=="85") echo "checked";?>>A</option>
                ...
                <option value="55" <?php if (isset($tg1) && $tg1=="55") echo "checked";?>>B-</option>
                <option value="50" <?php if (isset($tg1) && $tg1=="50") echo "checked";?>>C+</option>
                <option value="45" <?php if (isset($tg1) && $tg1=="45") echo "checked";?>>C</option>
              </select>
            </div>
        ...
        <table class="ui inverted fixed single line celled table ">
          ...
          <tbody>
            <tr>
              ...
              <td data-label="Minimum Marks">85</td>
            </tr>
            <tr>
              <td data-label="Letter">A-</td>
            ...
            <td data-label="Minimum Marks">45</td>
            </tr>
          </tbody>
        </table>
