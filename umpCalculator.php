...
<script>
  ...
  <title>CGPA Calculator UMP</title>
...
?>
  ...
  <div class="ui inverted grid ui container">
    <div class="sixteen wide column">
      <br>
      <img id="logo" src="umpLogo.png" alt="" width="125px;">
      <h1>CGPA Calculator (Universiti Malaysia Pahang)</h1>
    </div>
...
?>
      <div id="course-info">
        <h3>This grade conversion table is used at Universiti Malaysia Pahang (UMP)</h3>
